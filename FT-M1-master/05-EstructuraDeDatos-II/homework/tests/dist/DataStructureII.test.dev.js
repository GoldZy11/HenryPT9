...
var _require = require('../homework'),
    Node = _require.Node,
    LinkedList = _require.LinkedList,
    HashTable = _require.HashTable;
...
describe('Una linked list', function () {
  ...
  it('tiene metodos `add`, `remove`, y `search`', function () {
    expect(_typeof(linkedList.add)).toBe('function');
    expect(_typeof(linkedList.remove)).toBe('function');
    expect(_typeof(linkedList.search)).toBe('function');
  });
  ...
  it('tiene una clase Node para representar un nodo', function () {
    expect(_typeof(Node)).toBe('function');
...
describe('HashTable', function () {
  ...
  it('deberia tener metodos `set`, `get`, y `hasKey`', function () {
    expect(_typeof(hashTable.set)).toBe('function');
    expect(_typeof(hashTable.get)).toBe('function');
    expect(_typeof(hashTable.hasKey)).toBe('function');
  });
